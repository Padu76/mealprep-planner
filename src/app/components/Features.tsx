    ...
    <section className="max-w-7xl mx-auto px-4 py-20">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-gray-800 rounded-xl overflow-hidden shadow-xl">
          ...
          <div className="p-6">
            <h3 className="text-xl font-bold mb-3">🔀 Sostituzione Ingredienti</h3>
            <p className="text-gray-300">Non hai un ingrediente? Il sistema ti suggerisce alternative intelligenti considerando allergie e preferenze.</p>
          </div>
        </div>
      </div>
    </section>
