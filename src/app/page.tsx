        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-800 rounded-xl overflow-hidden shadow-xl">
            <div className="bg-gradient-to-br from-yellow-400 to-orange-500 h-48 rounded-t-xl flex items-center justify-center p-4">
              <img src="https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=400&h=300&fit=crop&crop=center" alt="Ricette Varie e Gustose" className="w-full h-full object-cover rounded-lg" />
            </div>
            <div className="p-6">
          ...
          <div className="bg-gray-800 rounded-xl overflow-hidden shadow-xl">
            <div className="bg-gradient-to-br from-pink-400 to-purple-500 h-48 rounded-t-xl flex items-center justify-center p-4">
              <img src="https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&h=300&fit=crop&crop=center" alt="Mobile-Friendly" className="w-full h-full object-cover rounded-lg" />
            </div>
            <div className="p-6">
